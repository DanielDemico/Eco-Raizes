...
const HeroSection: React.FC<HeroSectionProps> = ({ whatsappNumber, whatsappMessage }) => {
  return (
    <section id="hero" className="relative bg-cover bg-center h-[calc(100vh-80px)] min-h-[500px] flex items-center justify-center text-white" style={{ backgroundImage: "url('https://picsum.photos/1920/1080?random=1&grayscale&blur=2')" }}>
